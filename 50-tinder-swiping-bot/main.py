...
SIMILAR_ACCOUNT = "ACCOUNT_NAME"  # Change this to an account of your choice
    ...
    def follow(self):
        ...
        for button in all_buttons:
            try:
                button.click()
                time.sleep(1.1)
            # Clicking the button for someone who is already being followed will trigger a dialog to Unfollow/Cancel
